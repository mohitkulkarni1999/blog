...
import { Save, Image as ImageIcon, CheckCircle, AlertCircle, Trash2, Plus, FileText, Search, Tag, ChevronDown, X } from 'lucide-react';
        ...
        <div className="min-h-screen pb-16">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
                <div>
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Fill in the details below to publish or save a draft.</p>
                </div>
                ...
                <div className="grid grid-cols-1 xl:grid-cols-[1fr_340px] gap-6">
                    ...
                    <div className="space-y-5">
                        ...
                        <div className="bg-white dark:bg-dark-card rounded-2xl border border-gray-100 dark:border-dark-border shadow-soft p-5">
                            ...
                            >
                                {loading ? 'Saving...' : <><Save size={16} /> Save Post</>}
                            </button>
                        </div>
                        ...
                        <div className="bg-gradient-to-br from-primary-600/10 to-primary-400/5 dark:from-primary-900/30 dark:to-transparent rounded-2xl border border-primary-100 dark:border-primary-900/40 p-5">
                            <h4 className="text-xs font-black text-primary-700 dark:text-primary-400 uppercase tracking-widest mb-3">✨ Writing Tips</h4>
                            <ul className="space-y-2 text-xs text-gray-500 dark:text-gray-400 leading-relaxed">
                                <li>• Use <code className="bg-white/60 dark:bg-white/10 px-1 rounded text-primary-600 dark:text-primary-400">h2</code>, <code className="bg-white/60 dark:bg-white/10 px-1 rounded text-primary-600 dark:text-primary-400">h3</code> tags to structure content</li>
                                <li>• Keep meta title under 60 chars for best SEO</li>
                                <li>• Add an engaging featured image to boost clicks</li>
                                <li>• Save as Draft first, publish when ready</li>
                            </ul>
                        </div>
                    </div>
                </div>
